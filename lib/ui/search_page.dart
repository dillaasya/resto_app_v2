...
import 'package:resto_app_v2/data/provider/search_provider.dart';
import 'package:resto_app_v2/data/provider/theme_provider.dart';
import 'package:resto_app_v2/widget/third_card.dart';
    ...
    return Expanded(
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ThirdCard(restaurant: restaurant);
        },
      ),
    );
